<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100 transition-colors duration-300">
    ...
    <header class="sticky top-0 z-10 bg-white dark:bg-gray-800 shadow-md dark:shadow-gray-900 transition-colors duration-300">
      <div class="container mx-auto max-w-screen-lg px-4 py-4">
        ...
        <div class="flex items-center justify-between mb-2">
          <h2 class="text-lg font-bold text-gray-700 dark:text-gray-100">Entrada de Datos CSV</h2>
          <button
        ...
        <div 
          ...
          <template #default="{ activeTab }">
            ...
            <Tab label="Subir archivo" icon="upload">
              <div class="tab-content p-4 bg-white dark:bg-gray-800 shadow rounded-md transition-colors duration-300">
                <div class="mb-4">
                  <label class="block text-gray-700 dark:text-gray-100 font-semibold mb-2">Seleccionar archivo CSV</label>
                  <input 
                    type="file" 
                    ref="fileInput"
                    accept=".csv,.CSV"
                  ...
                  <p v-if="archivoSeleccionado" class="mt-2 text-sm text-gray-600 dark:text-gray-100">
                    ✓ Archivo seleccionado: <strong class="text-gray-800 dark:text-white">{{ archivoSeleccionado.name }}</strong>
                ...
                <div v-if="contenidoCsv || archivoSeleccionado" class="mt-4">
                  <label class="block text-gray-700 dark:text-gray-100 font-semibold mb-2">
                    Contenido del archivo
                    <span v-if="archivoSeleccionado" class="text-sm font-normal text-gray-500 dark:text-gray-300">
            ...
            <Tab label="URL" icon="link">
              <div class="tab-content p-4 bg-white dark:bg-gray-800 shadow rounded-md transition-colors duration-300">
                <div class="mb-4">
                  <label class="block text-gray-700 dark:text-gray-100 font-semibold mb-2">Ingresar URL del archivo CSV</label>
                  ...
                  <p v-if="urlCsv && !errorUrl" class="mt-2 text-sm text-gray-600 dark:text-gray-100">
                    URL: <strong class="break-all text-gray-800 dark:text-white">{{ urlCsv }}</strong>
                  </p>
                ...
                <div v-if="contenidoCsv || urlCsv" class="mt-4">
                  <label class="block text-gray-700 dark:text-gray-100 font-semibold mb-2">
                    ...
                    <span v-if="urlCsv" class="text-sm font-normal text-gray-500 dark:text-gray-300">
                      (puedes editar el contenido si es necesario)
                    </span>
                  </label>
                  <textarea 
    ...
    <main class="container mx-auto max-w-screen-lg px-4 py-8 bg-transparent dark:bg-transparent">
